...
{
    public class RelationsModelMapperAction : IMappingAction<User, RelationsModel>
    {
        ...
        public void Process(User source, RelationsModel destination, ResolutionContext context)
        {
